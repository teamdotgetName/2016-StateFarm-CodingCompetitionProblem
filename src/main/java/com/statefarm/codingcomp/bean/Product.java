...
public enum Product
{
	AUTO("Auto Insurance"), HOME_AND_PROPERTY("Home and Property Insurance"), LIFE("Life Insurance"), HEALTH(
			"Health Insurance"), BANK("Banking Products"), ANNUITIES("Annuities"), MUTUAL_FUNDS("Mutual Funds");
